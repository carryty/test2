...
class CircularLaneEnv(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        config.update({
            "observation": {
                "type": "Kinematics",
                "absolute": True,
                "features": ["presence", "x", "y", "vx", "vy", "Lane_type"],  #
    ...
    def _create_vehicles(self) -> None:
        ...
        if create_vehicles:
            v = other_vehicles_type.lane_create_random(self.road, lane_from=["b"], speed=10)
            v.randomize_behavior()
            self.road.vehicles.append(v)
            self.road.vehicles.append(
                other_vehicles_type.lane_create_random(self.road, lane_from=["b"], speed=10))
            self.road.vehicles.append(
                other_vehicles_type.lane_create_random(self.road, lane_from=["c"], speed=17))
            self.road.vehicles.append(
                other_vehicles_type.lane_create_random(self.road, lane_from=["d"], speed=18))
            self.road.vehicles.append(
                other_vehicles_type.lane_create_random(self.road, lane_from=["e"], speed=17))
            self.road.vehicles.append(
