...
class MergeEnv(AbstractEnv):
    ...
    def _make_road(self) -> None:
        ...
        c, s, n = LineType.CONTINUOUS_LINE, LineType.STRIPED, LineType.NONE  # 实线 虚线 没有线
        y = [0, StraightLane.DEFAULT_WIDTH]    # [0, 4]
        line_type = [[c, s], [n, c]]
    ...
    def _make_vehicles(self) -> None:
        ...
        road.vehicles.append(other_vehicles_type(road, road.network.get_lane(("a", "b", 0)).position(90, 0), speed=39))
        road.vehicles.append(other_vehicles_type(road, road.network.get_lane(("a", "b", 1)).position(70, 0), speed=36))
